<div class="rounded-md bg-green-50 p-4 mb-3 dark:bg-green-500/10 dark:outline dark:outline-green-500/20">
    <div class="flex">
        <div class="shrink-0">
        ...
        <div class="ml-3">
            <h3 class="text-sm font-medium text-green-700 dark:text-green-200/85">
                {{ $slot }}
            </h3>
        </div>
    </div>
