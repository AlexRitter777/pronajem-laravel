<div class="rounded-md bg-yellow-50 p-4 mb-3 dark:bg-yellow-500/10 dark:outline dark:outline-yellow-500/15">
    <div class="flex">
        <div class="shrink-0">
        ...
        <div class="ml-3">
            <h3 class="text-sm font-medium text-yellow-700 dark:text-yellow-100/80">
                {{ $slot }}
            </h3>
        </div>
    </div>
