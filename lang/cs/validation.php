...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'landlord_id' => 'pronajímatel',
        'tenant_name' => 'nájemník',
        'tenant_id' => 'nájemník',
        'property_address' => 'adresa nemovitosti',
        'property_id' => 'nemovitost',
        'invoicingYear' => 'rok vyúčtování',
        'tenantOccupancyStartDate' => 'počáteční datum',
        'tenantOccupancyEndDate' => 'konečné datum',

        'useOneCoefficient' => 'použití jednoho koeficientu',
        'useManyCoefficients' => 'použití více koeficientů',
        'coefficients' => 'koeficienty',
        'coefficients.*' => 'koeficient',

        'hasMeters' => 'použití měřidel',
        'meters' => 'měřidla',
        'meters.*.id' => 'měřidlo',
        'meters.*.typeId' => 'typ měřidla',
        'meters.*.typeName' => 'typ měřidla',
        ...
        'utilityRates' => 'sazby služeb',
        'hotWaterRate' => 'sazba teplé vody',
        'hotWaterRate.fixedAmount' => 'základní složka',
        'hotWaterRate.unitPrice' => 'jednotková cena teplé vody',
        'coldWaterForHotRate' => 'sazba studené vody pro teplou vodu',
        'coldWaterForHotRate.unitPrice' => 'jednotková cena studené vody pro teplou vodu',
        'coldWaterRate' => 'sazba studené vody',
        'coldWaterRate.unitPrice' => 'jednotková cena studené vody',
        'heatingRate' => 'sazba vytápění',
        'heatingRate.fixedAmount' => 'základní složka',
        ...
        'meterEndYearValue' => 'stav měřidla na konci roku',
        'annualConsumption' => 'roční spotřeba',

        'expenses' => 'náklady',
        'expenses.*.id' => 'náklad',
        'expenses.*.expenseTypeId' => 'typ nákladu',
        'expenses.*.expenseTypeName' => 'typ nákladu',
